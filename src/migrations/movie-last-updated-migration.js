...
;(async () => {
  try {
    ...
    const host = "mongodb+srv://m220student:m220password@mflix-1tlnq.mongodb.net/test?retryWrites=true"
    ...
    // over the wire!
    const predicate = { lastupdated: { $exist: true }, lastupdated: { $type: 'string'} }
